...
- (void)viewDidLoad {
    [super viewDidLoad];
    UIButton *psdCheckBox = [[UIButton alloc] initWithFrame:CGRectMake(47, 135, 20, 20)];
    psdCheckBox.backgroundColor = [UIColor redColor];
    [self.view addSubview:psdCheckBox];
    UIButton *loginCheckBox = [[UIButton alloc] initWithFrame:CGRectMake(125, 135, 20, 20)];
    loginCheckBox.backgroundColor = [UIColor redColor];
    [self.view addSubview:loginCheckBox];
    UILabel *remPassqord = self.certificateRem;
